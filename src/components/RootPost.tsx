...
export default function RootPost({ rootUri, isDirectReply, onClick }: RootPostProps) {
  ...
  return (
    <div
      className="px-4 pt-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors opacity-65"
      onClick={handleClick}
    >
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0 pb-6">
          ...
          {record?.text && (
            <div className="whitespace-pre-wrap break-words" style={{ fontSize: 'var(--post-text-size)', lineHeight: 'var(--post-text-leading)' }}>
