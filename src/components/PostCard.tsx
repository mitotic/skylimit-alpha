    ...
    <article
      ...
      style={isViewedOld ? {
        background: theme === 'dark'
          ? 'linear-gradient(to bottom, rgba(120,113,108,0.15) 0%, transparent 6%, transparent 94%, rgba(120,113,108,0.15) 100%), linear-gradient(to right, rgba(120,113,108,0.15) 0%, transparent 24px, transparent calc(100% - 24px), rgba(120,113,108,0.15) 100%)'
          : 'linear-gradient(to bottom, rgba(168,162,158,0.18) 0%, transparent 6%, transparent 94%, rgba(168,162,158,0.18) 100%), linear-gradient(to right, rgba(168,162,158,0.18) 0%, transparent 24px, transparent calc(100% - 24px), rgba(168,162,158,0.18) 100%)'
      } : undefined}
    >
      {repostedBy && (
